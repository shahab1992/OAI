                                 ...
                                 unsigned char symbol)
{
  ...
  LTE_UE_DLSCH_t **dlsch_ue       = phy_vars_ue->dlsch[phy_vars_ue->current_thread_id][eNB_id];
  ...
  rxdataF = phy_vars_ue->common_vars.common_vars_rx_data_per_thread[phy_vars_ue->current_thread_id].rxdataF;

  dl_bf_ch_estimates = phy_vars_ue->pdsch_vars[phy_vars_ue->current_thread_id][eNB_id]->dl_bf_ch_estimates;
