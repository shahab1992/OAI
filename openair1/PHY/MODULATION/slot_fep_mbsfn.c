                   ...
                   int no_prefix)
{
  ...
  for (aa=0; aa<frame_parms->nb_antennas_rx; aa++) {
    memset(&common_vars->common_vars_rx_data_per_thread[ue->current_thread_id].rxdataF[aa][frame_parms->ofdm_symbol_size*l],0,frame_parms->ofdm_symbol_size*sizeof(int));
    if (l==0) {
#if UE_TIMING_TRACE
      ...
      dft((int16_t *)&common_vars->rxdata[aa][(sample_offset +
          ...
          (int16_t *)&common_vars->common_vars_rx_data_per_thread[ue->current_thread_id].rxdataF[aa][frame_parms->ofdm_symbol_size*l],1);
#if UE_TIMING_TRACE
