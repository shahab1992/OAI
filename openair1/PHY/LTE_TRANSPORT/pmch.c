...
void dump_mch(PHY_VARS_UE *ue,uint8_t eNB_id,uint16_t coded_bits_per_codeword,int subframe)
{
  ...
  */
  ...
  write_output("mch00_ch0.m","pmch00_ch0",
               &(ue->common_vars.common_vars_rx_data_per_thread[ue->current_thread_id].dl_ch_estimates[eNB_id][0][0]),
            ...
            unsigned char symbol)
{
  ...
  mch_extract_rbs(common_vars->common_vars_rx_data_per_thread[ue->current_thread_id].rxdataF,
