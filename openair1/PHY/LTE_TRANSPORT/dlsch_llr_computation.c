                          ...
                          int16_t **llr16p)
{
  ...
  short *rxF_256i      = (short*) malloc16_clear(len256i*4);
  short *rxF_i_256i    = (short*) malloc16_clear(len256i*4);
  short *ch_mag_256i   = (short*) malloc16_clear(len256i*4);
  short *ch_mag_i_256i = (short*) malloc16_clear(len256i*4);
  short *rho_256i      = (short*) malloc16_clear(len256i*4);
