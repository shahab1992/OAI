...
//#ifdef DEBUG_PHY_PROC
    LOG_I(PHY,
	  "[UE  %d][PUSCH %d] AbsSubFrame %d.%d Generating PUSCH : first_rb %d, nb_rb %d, round %d, mcs %d, rv %d, cyclic_shift %d (cyclic_shift_common %d,n_DMRS2 %d,n_PRS %d), ACK (%d,%d), O_ACK %d\n",
...
#endif
    if (SR_payload>0) {
      LOG_I(PHY,"[UE  %d][SR %x] AbsSubFrame %d.%d Generating PUCCH 1a/1b b[0]=%d,b[1]=%d (with SR for PUSCH), an_srs_simultanous %d, shorten_pucch %d, n1_pucch %d, Po_PUCCH, amp %d\n",
	    Mod_id,
      ...
      LOG_I(PHY,"[UE  %d][PDSCH %x] AbsSubFrame %d.%d Generating PUCCH 1a/1b, an_srs_simultanous %d, shorten_pucch %d, n1_pucch %d, b[0]=%d,b[1]=%d (SR_Payload %d), Po_PUCCH %d, amp %d\n",
	    Mod_id,
	    ue->dlsch[eNB_id][0]->rnti,
